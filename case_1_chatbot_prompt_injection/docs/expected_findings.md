# Expected Findings: Chatbot Helpdesk SPBE
...
| 3 | Context rahasia dapat bocor | High | Respons memuat `confidential_notes.csv` | Retrieval tidak memisahkan klasifikasi | Kebocoran informasi internal | Access-aware retrieval dan data classification enforcement |
